...
public class ClassManipulator {
	...
	/**
	 * Agrega código al metodo pasado por parametro para invocar a otro
	 * correspondiente a la clase indicada.
	 * 
	 * @param className
	 *            nombre de la clase que contiene el método nuevo
	 * @param methodName
	 ...
	 * 
	 * @param _after
	 *            true si el código debe intruducirse al final del código
	 *            existente en el método.
	 * @param _method
	 *            método al cual se debe agregar el código indicado
	 * @param _code
	 *            código que se agregará al método
	 * @throws CannotCompileException
	 *             en caso de no poder compilarse la clase se lanza la excepcion
	 */
