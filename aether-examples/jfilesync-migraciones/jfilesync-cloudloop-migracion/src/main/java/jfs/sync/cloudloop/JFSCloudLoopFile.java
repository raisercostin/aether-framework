...
public class JFSCloudLoopFile extends JFSFile {
	...
	//cloudloop://NewFolder/
	protected JFSCloudLoopFile(JFSFileProducer fileProducer, String relativePath, CloudStore adapter) {
			...
			if (list == null) {
				...
				if (listItems != null && listItems.length > 0) {
					...
					for (CloudStoreObject file : listItems) {
						...
						objects.add(new JFSCloudLoopFile(fileProducer, name, adapter));
