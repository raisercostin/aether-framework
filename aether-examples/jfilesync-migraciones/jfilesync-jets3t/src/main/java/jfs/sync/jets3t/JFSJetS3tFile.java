...
public class JFSJetS3tFile extends JFSFile {
	...
	private GoogleStorageService adapter;
	private StorageObject itemData;

	//jets3t://testbuckettt/NewFolder/
	protected JFSJetS3tFile(JFSFileProducer fileProducer, String relativePath, GoogleStorageService adapter, String bucket) {
