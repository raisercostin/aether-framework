...
public class PlainPage {
	...
	class Paint {
		 ...
		 * comment2
		 */
		final int[][] ColorModes = new int[][] { { 0xdddddd, BLACK.getRGB(), BLUE.getRGB(), RED.getRGB(), 0xC85032, 0x115511, 0xffffff, 0xF0F0F0, 0xffffff }, { 0x0, LIGHT_GRAY.getRGB(), YELLOW.darker().getRGB(), GREEN.getRGB(), BLUE.brighter().getRGB(), 0xC85032, LIGHT_GRAY.getRGB(), 0x222222, 0x404040 },
				{ BLUE.darker().getRGB(), LIGHT_GRAY.getRGB(), YELLOW.getRGB(), GREEN.getRGB(), RED.getRGB(), 0x008800, LIGHT_GRAY.getRGB(), 0x2222ff, 0x0 } };
	...
	private File cacheDirectory = new File(PropertiesProvider.getProperty("gs.bucket"));
