...
public class JetS3tAdapter {
	...
	public JetS3tAdapter() {
		AWSCredentials awsCredentials = new AWSCredentials(PropertiesProvider.getProperty("aws.access"), PropertiesProvider.getProperty("aws.secret"));
		try {
	...
	public void populateCache() {
		...
		try {
			S3Object[] listObjects = s3Service.listObjects(bucket);
